...
python "$(dirname "$0")/../finetune_reward_protein.py" \
    --wandb_mode online \
    --wandb_group protein_distillation_IFNAR2 \
    --wandb_name RWMLE_ifnar2_K4_i1p01r002_rnormal_lr1e-5_lmbda1_oldin5_alpha1_rxt_rgennew_rstep \
...
python "$(dirname "$0")/../finetune_reward_protein.py" \
    --wandb_mode online \
    --wandb_group protein_distillation_IFNAR2 \
    --wandb_name DDPO_ifnar2_bs32_K4_old1rollin_rnorm_lr1e-5_lmbda1 \
    --reward iptm,plddt,radius \
    --reward_weight 1,0.1,0.02 \
    --bind_target IFNAR2 \
    --batch_size 32 \
